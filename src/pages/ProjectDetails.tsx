            ...
            <section className="space-y-8">
                <div className="rounded-xl border border-slate-700 bg-slate-950/80 p-8 backdrop-blur-xl">
                    ...
                    <Link
                        ...
                        className="mt-6 inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-violet-500 to-cyan-400 px-4 py-3 font-mono text-xs font-bold uppercase tracking-[0.22em] text-white"
                    >
                        Back to projects
        ...
        <section className="relative isolate space-y-10 text-slate-200">
            ...
            <header className="grid gap-6 lg:grid-cols-12 lg:items-end">
                <div className="lg:col-span-8 space-y-5">
                    <Link
                        to={ActiveTab.Projects}
                        className="inline-flex items-center gap-2 font-mono text-[10px] uppercase tracking-[0.28em] text-cyan-300 transition-colors hover:text-cyan-200"
                    >
                        <ChevronLeftIcon size={14} />
                        back to projects
                    </Link>

                    <div className="inline-flex items-center gap-3 rounded-full border border-slate-700 bg-slate-950/70 px-4 py-2 font-mono text-[11px] uppercase tracking-[0.28em] text-cyan-300 backdrop-blur-xl">
                    ...
                    <div className="flex flex-wrap gap-3">
                        {project.demoUrl && (
                            <a
                                ...
                                className="inline-flex items-center gap-3 rounded-md bg-gradient-to-r from-violet-500 to-cyan-400 px-5 py-3 font-mono text-xs font-bold uppercase tracking-[0.24em] text-white transition-all hover:brightness-110 hover:shadow-[0_0_18px_rgba(34,211,238,0.25)] active:scale-[0.98]"
                            >
                                Open demo
                                <PlayIcon size={16} />
                            </a>
                    ...
                    <div className="rounded-xl border border-slate-700 bg-slate-950/70 p-5 backdrop-blur-xl">
                        <div className="mb-5 flex items-center justify-between border-b border-slate-800 pb-4">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-slate-200">Project telemetry</p>
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {metrics.map((metric) => (
                                ...
                                >
                                    ...
                                    <div className="mt-2 font-mono text-[10px] uppercase tracking-[0.25em]" style={{color: metric.color}}>
                                        {metric.label}
                                    </div>
                        ...
                        <div className="mt-5 rounded-lg border border-slate-800 bg-slate-900/60 p-4">
                            ...
                            <p className="mt-2 text-sm leading-6 text-slate-200">
                                {hoveredMetric
                                    ? `${hoveredMetric}: ${
                                        metrics.find((metric) => metric.label === hoveredMetric)?.desc
                                    }`
                                    : 'Hover a metric to inspect project quality signals.'}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="grid gap-6 xl:grid-cols-12">
                <div className="xl:col-span-7 rounded-xl border border-slate-700 bg-slate-900/70 backdrop-blur-xl overflow-hidden">
                    <div className="flex items-center justify-between border-b border-slate-800 px-5 py-4">
                        <div>
                            <p className="font-mono text-[10px] uppercase tracking-[0.28em] text-slate-400">
                                architecture
                            </p>
                            <h2 className="mt-1 text-lg font-semibold text-slate-100">Problem, solution, delivery</h2>
                        </div>
                        <span className="rounded-full border border-violet-400/30 bg-violet-500/10 px-3 py-1 font-mono text-[10px] uppercase tracking-[0.22em] text-violet-200">
                            case study
                        </span>
                    </div>
                    ...
                    <div className="space-y-5 p-5">
                        ...
                        <div className="rounded-lg border border-slate-800 bg-slate-950/70 p-5">
                            ...
                            <div className="mt-4 flex flex-wrap gap-2">
                                ...
                                <span className="rounded-full border border-slate-700 bg-slate-900 px-3 py-1 font-mono text-[10px] uppercase tracking-[0.22em] text-slate-300">
                                    {projectImages.length.toString().padStart(2, '0')} assets
                                </span>
                                {project.demoUrl && (
                                    <span className="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 font-mono text-[10px] uppercase tracking-[0.22em] text-cyan-200">
                                        live demo
                                    </span>
                                )}
                                {project.codeUrl && (
                                    <span className="rounded-full border border-violet-400/20 bg-violet-400/10 px-3 py-1 font-mono text-[10px] uppercase tracking-[0.22em] text-violet-200">
                                        source
                                    </span>
                                )}
                            </div>
                ...
                <div className="xl:col-span-5 rounded-xl border border-slate-700 bg-slate-950/70 p-5 backdrop-blur-xl">
                    <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                        <div>
                            ...
                            <h2 className="mt-1 text-lg font-semibold text-slate-100">Visual evidence</h2>
                        </div>
                    ...
                    <div className="mt-5 space-y-4">
                        <div className="overflow-hidden rounded-xl border border-slate-800 bg-slate-900/60">
                            {activeImage ? (
                                ...
                                <div className="flex min-h-[280px] items-center justify-center bg-slate-900 text-slate-400">
            ...
            <section className="grid gap-6 lg:grid-cols-12">
                <div className="lg:col-span-8 rounded-xl border border-slate-700 bg-slate-950/70 p-6 backdrop-blur-xl">
                    ...
                    <h2 className="mt-2 text-2xl font-semibold text-slate-100">
                        The project combines design, implementation, and delivery metadata in one place.
                    </h2>
                    <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-300">
                        This page now owns the full project detail experience. The index remains a browsing surface,
                        while this route carries the full case study, screenshots, and outbound links.
                    </p>
                </div>

                <div className="lg:col-span-4 rounded-xl border border-slate-700 bg-gradient-to-r from-violet-500/10 to-cyan-400/10 p-6 backdrop-blur-xl">
                    <p className="font-mono text-[10px] uppercase tracking-[0.28em] text-slate-300">
                        next action
                    </p>
                    <h3 className="mt-2 text-xl font-semibold text-slate-100">Start the conversation</h3>
                    <p className="mt-2 text-sm leading-6 text-slate-300">
                        If this project aligns with your stack, use the contact route to open a scoped brief.
                    </p>
                    <Link
                        to={ActiveTab.Contact}
                        className="mt-5 inline-flex items-center gap-2 rounded-md bg-gradient-to-r from-violet-500 to-cyan-400 px-4 py-3 font-mono text-xs font-bold uppercase tracking-[0.24em] text-white transition-all hover:brightness-110"
                    >
                        Contact
                        <ArrowRightIcon size={16} />
                    </Link>
